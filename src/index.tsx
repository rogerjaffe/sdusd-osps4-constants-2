...
const CONSTANTS = {
  ...
  OSPS_DATA,
  PS_FIELDS,
  UPDATE: {ELA, ELE, HIS, LOE, MTH, NCR, OTH, PED, SCI, VPA},
  ...
  PERMISSIONS_SETS: {
    OSPS_READ: PERMISSIONS.INDIVIDUAL.PROFILE |
      PERMISSIONS.INDIVIDUAL.FILTER |
      PERMISSIONS.INDIVIDUAL.AT_RISK |
      PERMISSIONS.INDIVIDUAL.SETTINGS |
      PERMISSIONS.INDIVIDUAL.GRADE_VALIDATION,
    OSPS_WRITE: PERMISSIONS.INDIVIDUAL.PROFILE |
      PERMISSIONS.INDIVIDUAL.FILTER |
      PERMISSIONS.INDIVIDUAL.AT_RISK |
      PERMISSIONS.INDIVIDUAL.SETTINGS |
      PERMISSIONS.INDIVIDUAL.DEF_LETTER_NOTES |
      PERMISSIONS.INDIVIDUAL.CONFIDENTIAL_NOTES |
      PERMISSIONS.INDIVIDUAL.GRADE_VALIDATION,
    OSPS_ALTERNATIVE: PERMISSIONS.INDIVIDUAL.PROFILE |
      PERMISSIONS.INDIVIDUAL.FILTER |
      PERMISSIONS.INDIVIDUAL.AT_RISK |
      PERMISSIONS.INDIVIDUAL.SETTINGS |
      PERMISSIONS.INDIVIDUAL.DEF_LETTER_NOTES |
      PERMISSIONS.INDIVIDUAL.SEARCH |
      PERMISSIONS.INDIVIDUAL.CONFIDENTIAL_NOTES |
      PERMISSIONS.INDIVIDUAL.GRADE_VALIDATION,
    OSPS_DISTRICT: PERMISSIONS.INDIVIDUAL.PROFILE |
      PERMISSIONS.INDIVIDUAL.FILTER |
      PERMISSIONS.INDIVIDUAL.AT_RISK |
      PERMISSIONS.INDIVIDUAL.SETTINGS |
      PERMISSIONS.INDIVIDUAL.DEF_LETTER_NOTES |
      PERMISSIONS.INDIVIDUAL.SEARCH |
      PERMISSIONS.INDIVIDUAL.CONFIDENTIAL_NOTES |
      PERMISSIONS.INDIVIDUAL.COURSES |
      PERMISSIONS.INDIVIDUAL.SCHOOL_INFO |
      PERMISSIONS.INDIVIDUAL.LOG |
      PERMISSIONS.INDIVIDUAL.GRADE_VALIDATION,
